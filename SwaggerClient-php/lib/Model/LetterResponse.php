...
/**
 * LetterResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LetterResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LetterResponse';
...
'pdf_file_id' => 'getPdfFileId'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pdf_file_id'] = isset($data['pdf_file_id']) ? $data['pdf_file_id'] : null;
    }
     ...
     * Sets id
     *
     * @param string $id ID of the Letter
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of person(s) that the letter is being sent to, this will appear on the outside of the envelope
     *
     * @return $this
     */
     ...
     * Sets time_created
     *
     * @param string $time_created Date and time the letter was added to the system
     *
     * @return $this
     */
    ...
    {
        return $this->container['pdf_file_id'];
    }

    /**
     * Sets pdf_file_id
     *
     * @param \DateTime $pdf_file_id ID of the PDF file containing the letter
     *
     * @return $this
     */
    public function setPdfFileId($pdf_file_id)
    {
        $this->container['pdf_file_id'] = $pdf_file_id;
